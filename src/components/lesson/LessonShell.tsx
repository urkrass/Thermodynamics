  ...
  return (
    <div className="lesson-shell">
      <div className="lesson-surface flex flex-col">
        ...
        <main className="mx-auto flex w-full max-w-5xl flex-1 px-5 pb-5 pt-3 sm:px-8 sm:pb-8">
        ...
        <footer className="mx-auto flex w-full max-w-5xl flex-col gap-3 px-5 pb-5 sm:px-8 sm:pb-8 md:flex-row md:items-center md:justify-between">
          <button
            type="button"
